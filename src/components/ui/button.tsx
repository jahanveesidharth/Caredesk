...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: 'bg-brand-teal hover:bg-brand-teal-hover text-white focus:ring-brand-teal',
    outline: 'border border-border-main text-text-main hover:bg-bg-surface-hover focus:ring-brand-primary',
    danger: 'bg-red-600 hover:bg-red-700 text-white focus:ring-red-500',
    ghost: 'text-text-muted hover:text-text-main hover:bg-bg-surface-hover focus:ring-brand-primary',
  };
